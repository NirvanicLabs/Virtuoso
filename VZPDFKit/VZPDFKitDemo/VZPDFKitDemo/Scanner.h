...
@interface Scanner : NSObject <StringDetectorDelegate> {
    ...
    NSMutableString *__strong *rawTextContent;
}
...
@property (nonatomic, assign) NSMutableString *__strong *rawTextContent;
@property (nonatomic, retain) NSMutableString *strContent;
